...
function app(people){
  let searchType = promptFor("Do you know the name of the person you are looking for? Please enter 'yes' or 'no'.", yesNo).toLowerCase();
  let searchResults;
  switch(searchType){
    case 'yes':
...
function searchByOccupation(people){
  let occupation = promptFor("Please enter the person's occupation.", autoValid).toLowerCase();
